...
description: Instructions for managing project tasks and the usage of Backlog.md CLI Tool
---

# Instructions for the usage of Backlog.md CLI Tool

Project Level Instructions:
- When creating a task or beginning to implement a task always make sure the following is clearly included as part of the task AC: "Always use the coder agent for actual implementation. NEVER SKIP STEPS when using the coder Agent."
