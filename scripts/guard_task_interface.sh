...
TASK_SYSTEM_NAME="${TASK_SYSTEM_NAME:-Backlog.md CLI}"
TASK_ALLOWED_OPERATIONS="${TASK_ALLOWED_OPERATIONS:-create,list,read,claim,plan,notes,ac_update,summary,complete}"
if [[ -z "$OPERATION" ]]; then
